...
// Check out the teacher's plant edu.uc.zhukv.droneradarmap.service class in his plantDiary project to get an idea of what I'm talking about.
...
//        val edu.uc.zhukv.droneradarmap.service = RetrofitClientInstance.retrofitInstance?.create(IRetrofitWeatherDAO::class.java)
//        val forecast = async { edu.uc.zhukv.droneradarmap.service?.getAllForecast() }
//
//        updateLocalForecast(forecast.await())
//
//        val call = edu.uc.zhukv.droneradarmap.service?.getAllForecast()
